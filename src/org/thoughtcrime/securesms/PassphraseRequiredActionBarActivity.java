...
public abstract class PassphraseRequiredActionBarActivity extends BaseActionBarActivity implements MasterSecretListener {
    ...
    // to get routed intent according the passed params to open next one
    ...
    // this intent for luncher screen
    private Intent getCreatePassphraseIntent() {
        return getRoutedIntent(PassphraseCreateActivity.class, getIntent());
    }

    // this intent for luncher prompt locked screen
    ...
    // Welcome screen with green continue button
    private Intent getWelcomeIntent() {
        return getRoutedIntent(WelcomeActivity.class, getPushRegistrationIntent());
    }

    // registration screen with all fields - phone, verification, PIN, backup option - some of them are visible and others invisible based on their state
    private Intent getPushRegistrationIntent() {
        return getRoutedIntent(RegistrationActivity.class, getCreateProfileIntent());
    }

    // create name and avatar screen
    private Intent getCreateProfileIntent() {
        return getRoutedIntent(CreateProfileActivity.class, getOnBoardingIntent());
    }

    // on boarding screen with docs data
    private Intent getOnBoardingIntent() {
        // return new Intent(this, OnboardingActivity.class);
        return getRoutedIntent(OnboardingActivity.class, getConversationListIntent());
    }
