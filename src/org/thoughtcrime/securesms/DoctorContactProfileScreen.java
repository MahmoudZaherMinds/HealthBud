...
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.ADDRESS_EXTRA;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_ABOUT;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_BLOCK;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_CALL_TONE;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_CALL_VIBRATE;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_COLOR;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_CUSTOM_NOTIFICATIONS;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_IDENTITY;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_MESSAGE_TONE;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_MESSAGE_VIBRATE;
import static org.thoughtcrime.securesms.RecipientPreferenceActivity.PREFERENCE_MUTED;

public class DoctorContactProfileScreen extends PassphraseRequiredActionBarActivity implements RecipientModifiedListener, LoaderManager.LoaderCallbacks<Cursor> {


    private static final String TAG = DoctorContactProfileScreen.class.getSimpleName();
    public final DynamicTheme dynamicTheme = new DynamicNoActionBarTheme();
    public final DynamicLanguage dynamicLanguage = new DynamicLanguage();
    ...
    private void initializeToolbar() {
        ...
        this.threadPhotoRailView.setListener(mediaRecord -> {
            Intent intent = new Intent(DoctorContactProfileScreen.this, MediaPreviewActivity.class);
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        initFragment(R.id.preference_fragment, new DoctorContactProfileScreen.RecipientPreferenceFragment(), null, bundle);
    }
    ...
    public static class RecipientPreferenceFragment
        ...
        public void onCreate(Bundle icicle) {
            ...
            if (NotificationChannels.supported()) {
                ...
                customNotificationsPref.setOnPreferenceChangeListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.CustomNotificationsChangedListener());
                ...
                if (recipient.getNotificationChannel() != null) {
                    ...
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        protected Void doInBackground(Void... voids) {
                            ...
                            db.setMessageVibrate(recipient, NotificationChannels.getMessageVibrate(context, recipient) ? RecipientDatabase.VibrateState.ENABLED : RecipientDatabase.VibrateState.DISABLED);
            ...
            this.findPreference(PREFERENCE_MESSAGE_TONE)
                    .setOnPreferenceChangeListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.RingtoneChangeListener(false));
            this.findPreference(PREFERENCE_MESSAGE_TONE)
                    .setOnPreferenceClickListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.RingtoneClickedListener(false));
            this.findPreference(PREFERENCE_CALL_TONE)
                    .setOnPreferenceChangeListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.RingtoneChangeListener(true));
            this.findPreference(PREFERENCE_CALL_TONE)
                    .setOnPreferenceClickListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.RingtoneClickedListener(true));
            this.findPreference(PREFERENCE_MESSAGE_VIBRATE)
                    .setOnPreferenceChangeListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.VibrateChangeListener(false));
            this.findPreference(PREFERENCE_CALL_VIBRATE)
                    .setOnPreferenceChangeListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.VibrateChangeListener(true));
            this.findPreference(PREFERENCE_MUTED)
                    .setOnPreferenceClickListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.MuteClickedListener());
        ...
        public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
            ...
            addPreferencesFromResource(R.xml.recipient_preferences_profile);
        }
                    ...
                    public void onSuccess(Optional<IdentityDatabase.IdentityRecord> result) {
                        if (result.isPresent()) {
                            if (identityPreference != null)
                                identityPreference.setOnPreferenceClickListener(new DoctorContactProfileScreen.RecipientPreferenceFragment.IdentityClickedListener(result.get()));
        ...
        private @NonNull
        Pair<String, Integer> getVibrateSummary(@NonNull Context context, @NonNull RecipientDatabase.VibrateState vibrateState) {
