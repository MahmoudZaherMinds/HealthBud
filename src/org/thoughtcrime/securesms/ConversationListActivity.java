...
//                                .commit();
    ...
    private void initializeSearchListener() {
        // get stored data from shared
        String name = GenaralUtils.getCachedString(ConversationListActivity.this, Constants.USER_NAME, "user name not found");
        String phone = GenaralUtils.getCachedString(ConversationListActivity.this, Constants.USER_PHONE, "phone name not found");
        String specialization = GenaralUtils.getCachedString(ConversationListActivity.this, Constants.USER_SPECIALIZATION, "SPECIALIZATION not found");
        String qualification = GenaralUtils.getCachedString(ConversationListActivity.this, Constants.USER_QUALIFICATION, "QUALIFICATION not found");
