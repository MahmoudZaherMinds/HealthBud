...
public class RecipientPreferenceActivity extends PassphraseRequiredActionBarActivity implements RecipientModifiedListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static final String PREFERENCE_MUTED = "pref_key_recipient_mute";
    public static final String PREFERENCE_MESSAGE_TONE = "pref_key_recipient_ringtone";
    public static final String PREFERENCE_CALL_TONE = "pref_key_recipient_call_ringtone";
    public static final String PREFERENCE_MESSAGE_VIBRATE = "pref_key_recipient_vibrate";
    public static final String PREFERENCE_CALL_VIBRATE = "pref_key_recipient_call_vibrate";
    public static final String PREFERENCE_BLOCK = "pref_key_recipient_block";
    public static final String PREFERENCE_COLOR = "pref_key_recipient_color";
    public static final String PREFERENCE_IDENTITY = "pref_key_recipient_identity";
    public static final String PREFERENCE_ABOUT = "pref_key_number";
    public static final String PREFERENCE_CUSTOM_NOTIFICATIONS = "pref_key_recipient_custom_notifications";
